...
//PORT A
#define DIO_PIN0_DIR OUT  // ADC 0
#define DIO_PIN1_DIR OUT  // ADC 1
...
// PORT D
#define DIO_PIN24_DIR IN  // Button 0
#define DIO_PIN25_DIR OUT  // Button 1
#define DIO_PIN26_DIR OUT  // Button 2
#define DIO_PIN27_DIR OUT
#define DIO_PIN28_DIR IN
#define DIO_PIN29_DIR IN
#define DIO_PIN30_DIR IN  // LED 0
#define DIO_PIN31_DIR IN  // LED 1
